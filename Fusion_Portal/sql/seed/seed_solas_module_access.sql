/* Ensure Solas module exists and grant full access to a user (by username).
...
USING (VALUES (N'Fusion Solas', N'/module/Solas', N'bi bi-sun', 1)) AS src (module_name, module_url, icon, is_active)
...
SELECT @module_id = module_id FROM ADM.Modules WHERE module_name = N'Fusion Solas';
